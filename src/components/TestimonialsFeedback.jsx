...
function TestimonialsFeedback() {
  return (
    <>
      <section
        className="bg-white py-[120px] testimonial aos-init aos-animate"
        data-aos="fade-up"
      >
        <div className="container mx-auto px-8 xl:pr-0 xl:pl-[4%] 2xl:pl-[6%] 3xl:pl-[17%]">
          <div className="flex flex-col xl:flex-row gap-x-[55px] 2xl:gap-x-[100px] 3xl:gap-x-[165px]">
            <div className="font-bold font-Syne leading-none flex flex-wrap flex-col gap-y-2 md:text-center xl:text-left mb-10">
              <span className="text-[#ffb646] text-xl">Testimonial</span>
              <h3 className="inline-block text-black text-4xl lg:text-5xl xl:text-[64px] tracking-[-1.5px]">
                <span className="relative z-[1] before:rounded-full before:bg-[#ffb646] before:block before:absolute before:top-[4px] before:left-[-2px] before:-z-[1] before:w-[36px] lg:before:w-[48px] xl:before:w-[64px] before:h-[36px] lg:before:h-[48px] xl:before:h-[64px]">
                  Cl
                </span>
                ient
            ...
            >
              <SwiperSlide>
                <div className="slide-content ">
                  ...
                  <h4 className="flex flex-wrap items-center gap-4 text-black text-[16px] sm:text-lg font-extrabold font-Syne leading-7">
                    <span>
                      <svg
                        width="48"
                        height="2"
            ...
            <div className="swiper-button-next absolute right-24 top-1/2 transform -translate-y-1/2 text-[#ffb646]"></div>
            <div className="swiper-button-prev absolute left-[660px] top-1/2 transform -translate-y-1/2 text-[#ffb646]"></div>
          </div>
        </div>
      </section>
    </>
