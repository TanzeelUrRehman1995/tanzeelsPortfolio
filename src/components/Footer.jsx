...
function Footer() {
  ...
  return (
    <>
      <footer class="footer bg-black pt-[80px] lg:pt-[100px] lg:px-5 xl:pt-[120px] pb-[60px]">
        <div class="container mx-auto">
          <div
            class="overflow-x-hidden "
            data-aos="flip-down"
          >
            <div class="grid md:grid-cols-1 lg:grid-cols-3 gap-5 lg:gap-6">
              <div class="pt-12">
                <h3 class="text-white font-Syne font-bold text-4xl lg:text-5xl xl:text-[64px] tracking-[-1.5px]">
                  <span class="relative z-[1] before:rounded-full before:bg-[#ffb646] before:block before:absolute before:top-[8px] before:left-[0] before:-z-[1] before:w-[36px] lg:before:w-[48px] xl:before:w-[60px] before:h-[36px] lg:before:h-[48px] xl:before:h-[60px]">
                    Le
                  </span>
                  t’s work together
                </h3>
                <div class="flex flex-wrap items-center mt-10">
                  ...
                  <div class="ml-5 md:ml-[5px] lg:ml-0 xl:ml-[16px] 2xl:ml-5">
                    <ul class="flex flex-wrap gap-x-4 items-center">
                      <li>
                        <a href="#" class="text-white hover:text-[#ffb646]">
                          <svg
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
              ...
              <div class="py-9 px-7 border-border-white border rounded-2xl flex flex-col justify-between group" onMouseEnter={()=>setHovered(true)} onMouseLeave={()=> setHovered(false)}>
                <h3 class="text-xl font-bold font-Syne text-white">
                  Looking for a hectic designer?
                </h3>
                <div class="flex justify-between items-center ">
                  <p class="text-xl font-bold font-Syne leading-none text-[#ffb646] ">
                    tanzeelurrehman1995@gmail.com
                  </p>
                  <a
                    href="#"
                    class={` ${hovered ? 'card-animate-arrow text-[#ffb646]' : 'text-white'}`}
                  >
                    <svg
                      width="40"
                      height="40"
              ...
              <div class="py-9 px-7 border-border-white border rounded-2xl  flex flex-col justify-between group" onMouseEnter={()=>setIsMHovered(true)} onMouseLeave={()=> setIsMHovered(false)}>
                <h3 class="text-xl font-bold font-Syne text-white">
                ...
                <div class="flex justify-between items-center ">
                  ...
                  <a
                    href="#"
                    class={` ${isMHovered ? 'card-animate-arrow text-[#ffb646]' : 'text-white'}`}
                  >
                    <svg
                      width="40"
                      height="40"
            ...
            <div class="grid grid-cols-1 gap-6">
              <div class="py-[72px]">
                <p className="font-Syne text-white font-extrabold text-center text-[40px] md:text-[45px] lg:text-[60px] xl:text-[75px] 2xl:text-[95px]">Tanzeel Ur Rehman</p>
              </div>
            </div>
              ...
              <div class="grid grid-cols-12">
                <div class="col-span-12 sm:col-span-8 order-last sm:order-first">
                  <p class="text-white text-lg font-normal font-sans leading-7">
                    ©2024 Tanzeel Ur Rehman, All Rights Reserved
                  </p>
                </div>
                <div class="col-span-12 sm:col-span-4 order-first sm:order-last " onMouseEnter={() => setIsBHovered(true)} onMouseLeave={()=> setIsBHovered(false)}>
                  <div class="flex justify-end mb-2 sm:mb-0">
                    ...
                    >
                      <span class="text-white text-lg font-normal font-sans leading-7 transition-all scroll-smooth  group-hover:text-[#ffb646]">
                        Back to Top
                      </span>
                      <svg
                        className={`${isBHovered ? 'card-animate-arrow' : ''}`}
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                        fill="none"
