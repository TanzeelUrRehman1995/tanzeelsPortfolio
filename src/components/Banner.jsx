...
function Banner() {
  ...
  useEffect(() => {
    const intervalId = setInterval(() => {
      setCount((prevCount) => {
        ...
        if (newCount >= 1.2) {
          clearInterval(intervalId); // Stop the counter when it reaches 1.2
          return 1.2; // Set count to 1.2
        }
        return newCount; // Continue incrementing otherwise
      });
    }, 200);
  ...
  return (
    <>
      <div className="w-full bg-[#ffe9d9] relative py-40">
        
        <div class="container mx-auto lg:px-5 flex xl:pt-12">
          <div>
            <span
            ...
            <h2
              class=" font-Syne text-black-800 font-bold text-[70px]  pl-2 leading-[64px] md:text-[50px] lg:leading-[80px] xl:leading-[90px] 2xl:leading-[110px] mb-10 "
              data-aos="fade-right"
              data-aos-delay="600"
            >
              Ur Rehman
            ...
            <div class="btn-animate flex flex-wrap mb-[50px] md:mb-[60px] xl:mb-[70px] 2xl:mb-[80px]">
              <span
                data-aos="fade-right"
                data-aos-delay="1000"
              ...
              >
                <Link
                  to="/ContactUs"
                  class="flex items-center flex-wrap bg-black text-white font-bold border px-5 py-4 rounded-lg btn-primary mr-2 group hover:bg-transparent hover:border hover:border-black hover:text-black"
                >
                  Let’s Talk
              ...
              >
                <Link
                  ...
                  to="#"
                  class="flex items-center flex-wrap bg-transparent text-black font-bold border border-black px-5 py-4 rounded-lg btn-primary mr-2 group hover:bg-black hover:border  hover:text-white "
                >
                  My Work
            ...
            >
              <div class="flex flex-wrap items-center">
                <span class="font-Syne text-black-800 font-bold text-[44px] leading-none">
                  <span class="counter is-visible visible">
                    {count.toFixed(1)}
                  </span>
                  k+
                </span>
              ...
              <div class="mt-5 sm:mt-0">
                <ul class="flex flex-wrap gap-x-4 items-center">
                  <li>
                    <Link href="#" className="text-black-800 hover:text-[#e5aa52]">
                      <svg
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                  ...
                  <li>
                    <Link to="#" class="text-black-800 hover:text-[#e5aa52]">
                      <svg
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
          ...
          <div className="absolute top-0 right-0 md:max-w-[420px] lg:max-w-[570px] xl:max-w-[650px] 2xl:max-w-[initial] hidden md:flex"
          data-aos='fade-left'
          data-aos-delay='600'
          >
